...
import { readId } from "../../routes/parsers/scalars"
import { readTemplateInput } from "../readTemplateInput"
import { createTemplate, deleteTemplate, updateTemplate } from "../store"
...
export function registerTemplateRoutes(app: Express): void {
  app.post(
      ...
      const template = readTemplateInput(req.body?.template)
