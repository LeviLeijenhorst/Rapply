...
const reintegratieplanWerkfit: UwvTemplate = {
  ...
  fields: [
    ...
    createField({ fieldId: "rp_werkfit_4_1", exportNumberKey: "4.1", label: "Ordernummer", fieldType: "programmatic" }),
    createField({
    ...
    createField({
      ...
      exportNumberKey: "7.2",
      label: "Visie op re-integratiemogelijkheden",
      fieldType: "ai",
      aiConfig: {
    ...
    createField({
      ...
      exportNumberKey: "7.3",
      label: "Verwachting inzet/resultaat re-integratiedienst",
      fieldType: "ai",
      aiConfig: {
...
const eindrapportageWerkfit: UwvTemplate = {
  ...
  fields: [
    ...
    createField({ fieldId: "er_werkfit_3_2", exportNumberKey: "3.2", label: "Naam contactpersoon re-integratiebedrijf", fieldType: "programmatic" }),
    ...
    createField({
      ...
      aiConfig: {
        ...
        skipLogica: [
          { when: { fieldId: "er_werkfit_4_2", equals: 1 }, skipFieldIds: ["er_werkfit_6_1", "er_werkfit_6_2"] },
          { when: { fieldId: "er_werkfit_4_2", equals: 2 }, skipFieldIds: ["er_werkfit_5_1", "er_werkfit_5_2"] },
          { when: { fieldId: "er_werkfit_4_2", equals: 3 }, skipFieldIds: ["er_werkfit_5_1", "er_werkfit_5_2", "er_werkfit_6_1", "er_werkfit_6_2"] },
        ],
        frontendVariant: "single_choice_numeric",
      },
    }),
    ...
    createField({
      ...
      aiConfig: {
        ...
        instructie: "Geef een korte feitelijke toelichting op basis van de broninformatie.",
        antwoordType: "text",
        voorbeeldAntwoord:
    ...
    createField({
      ...
      aiConfig: {
        ...
        instructie: "Onderbouw het resultaat met concrete observaties uit de broninformatie.",
        antwoordType: "text",
        voorbeeldAntwoord:
    ...
    createField({
      ...
      exportNumberKey: "7.6",
      label: "Vervolgadvies en benodigde begeleiding",
      fieldType: "ai",
      aiConfig: {
    ...
    createField({
      ...
      fieldType: "ai",
      aiConfig: {
        vraag: "Geef een toelichting op uw advies.",
    ...
    createField({
      ...
      exportNumberKey: "7.8",
      label: "Mening klant over advies",
      fieldType: "ai",
      aiConfig: {
        vraag: "Wat vindt de klant van dit advies?",
        instructie: "Beschrijf de reactie van de klant op het advies op basis van de broninformatie.",
        antwoordType: "text",
    ...
    createField({
      ...
      exportNumberKey: "8.1",
      label: "Ervaring klant met ingezette activiteiten",
      fieldType: "ai",
      aiConfig: {
    ...
    createField({
      ...
      exportNumberKey: "8.2",
      label: "Akkoord op begeleidingsuren",
      fieldType: "ai",
      aiConfig: {
        vraag: "Is de klant akkoord met het aantal door u ingezette en verantwoorde begeleidingsuren?",
        instructie: "Kies Ja/Nee en geef toelichting vooral bij Nee of wanneer toelichting expliciet aanwezig is.",
        antwoordType: "multiple_choice",
        opties: [
          { value: 1, label: "Ja" },
          { value: 2, label: "Nee" },
