  ...
  const result = await pool.query<{ table_name: string; column_name: string }>(`
    with expected(table_name, column_name) as (
      values
        ...
        ('audio_streams','id'),
        ('audio_streams','owner_user_id'),
        ('audio_streams','mime_type'),
        ('audio_streams','created_at_unix_milliseconds'),
        ('audio_stream_chunks','audio_stream_id'),
        ('audio_stream_chunks','chunk_index'),
        ('audio_stream_chunks','bytes'),
        ('meeting_recordings','id'),
        ('meeting_recordings','owner_user_id'),
        ('meeting_recordings','session_id'),
        ('meeting_recordings','audio_stream_id'),
        ('meeting_recordings','status'),
        ('meeting_recordings','language_code'),
        ('meeting_recordings','mime_type'),
        ('meeting_recordings','started_at_unix_ms'),
        ('meeting_recordings','created_at_unix_ms'),
        ('meeting_recordings','updated_at_unix_ms'),
        ('meeting_recording_tokens','token'),
        ...
        ('reports','created_by_user_id'),
        ('reports','report_text'),
        ('reports','updated_at_unix_ms'),
        ('report_coaches','report_id'),
        ('report_coaches','user_id'),
        ('organizations','name'),
