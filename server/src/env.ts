...
export const env = {
  ...
  azureOpenAiTranscriptionDeployment: optionalString("AZURE_OPENAI_TRANSCRIPTION_DEPLOYMENT") || "",
  azureOpenAiTranscriptionVersion: optionalString("AZURE_OPENAI_TRANSCRIPTION_VERSION") || "2024-02-15-preview",
  azureOpenAiTranscriptionModel: optionalString("AZURE_OPENAI_TRANSCRIPTION_MODEL") || "whisper-1",
