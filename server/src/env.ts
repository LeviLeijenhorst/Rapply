...
export const env = {
  ...
  selfHostedWhisperEndpoint: optionalString("SELF_HOSTED_WHISPER_ENDPOINT") || "",
  selfHostedWhisperApiKey: optionalString("SELF_HOSTED_WHISPER_API_KEY") || "",
  selfHostedWhisperTimeoutMs: optionalNumber("SELF_HOSTED_WHISPER_TIMEOUT_MS") ?? 20 * 60 * 1000,
  defaultTranscriptionMode: optionalString("DEFAULT_TRANSCRIPTION_MODE") || "batch",
  defaultTranscriptionProvider: optionalString("DEFAULT_TRANSCRIPTION_PROVIDER") || "azure-speech",
