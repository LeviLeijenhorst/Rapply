...
import { readTrajectoryInput } from "../readTrajectoryInput"
import { createTrajectory, deleteTrajectory, updateTrajectory } from "../store"
...
export function registerTrajectoryRoutes(app: Express): void {
  app.post(
      ...
      const trajectory = readTrajectoryInput(req.body?.trajectory)
