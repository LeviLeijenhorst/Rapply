...
import { readActivityInput, readOptionalActivitySource, readOptionalActivityStatus } from "../readActivityInput"
import { createActivity, deleteActivity, updateActivity } from "../store"
...
export function registerActivityRoutes(app: Express): void {
  app.post(
      ...
      const activity = readActivityInput(req.body?.activity)
