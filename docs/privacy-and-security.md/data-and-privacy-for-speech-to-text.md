...
A diagram of the data flow for Speech to text.
...
The security of customer data is a shared responsibility. Details on the security model of Azure AI containers, like the speech container can be found in Foundry Tools container security.
