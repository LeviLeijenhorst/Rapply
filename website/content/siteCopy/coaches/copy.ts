...
export const coachesCopy: SiteCopy = {
  ...
  coaches: {
    ...
    types: [
      ...
      },
      {
        title: "Lifecoach",
        description:
          "Een lifecoach helpt mensen bij persoonlijke vraagstukken en begeleidt hen in het creeren van meer balans, richting en bewustzijn in het dagelijks leven.",
      },
      {
        title: "Businesscoach",
        description:
      ...
      },
      {
        title: "Budgetcoach",
        description:
          "Een budgetcoach helpt mensen grip te krijgen op hun financien door inzicht te creeren in inkomsten, uitgaven en financiele keuzes.",
      },
      {
      ...
      },
      {
        title: "Nog veel meer",
        description:
          "Het coachingsveld is rijk en gevarieerd, met nog talloze coaches die elk op hun eigen manier impact maken en waarde toevoegen aan het traject van hun clienten.",
      },
    ],
  ...
  overOns: {
    ...
    heroTitleAccent: ":)",
    heroSubtext:
      "Wij geloven dat goede coaching begint bij rust, focus en aandacht. Coaches doen intens en betekenisvol werk en wij willen hen ondersteunen met tools die ruimte geven om echt aanwezig te zijn.",
    heroCta: "Contact",
    values: [
      {
        title: "Mensgericht",
        description:
          "Technologie ondersteunt altijd de coach en de client, zonder de menselijke connectie te vervangen.",
      },
      {
        title: "Samenwerking",
        description:
      ...
      },
      {
        title: "Verbinding",
        description:
          "Onze tools helpen coaches sterker in contact te staan met hun clienten en de relatie te verdiepen.",
      },
    ],
    founders: [
      {
