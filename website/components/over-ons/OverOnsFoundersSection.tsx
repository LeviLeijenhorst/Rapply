...
const founders: Founder[] = [
  {
    ...
    description: [
      "Levi heeft een achtergrond in toegepaste psychologie en ontdekte tijdens zijn werkzaamheden als begeleider hoe tijdrovend en mentaal belastend verslaglegging kan zijn.",
      "Dat inzicht vormde de basis voor Rapply.",
      "Als technisch oprichter is Levi verantwoordelijk voor alle beslissingen rond de technische architectuur, veiligheid en doorontwikkeling van het platform. Daarnaast is hij nauw betrokken bij design, gebruikerservaring en de gesprekken met coaches die Rapply dagelijks gebruiken.",
    ],
    image: leviImage,
  ...
  },
  {
    name: "Jonas Kroon",
    description: [
      "Jonas heeft een achtergrond in toegepaste psychologie en herkende direct de uitdagingen waar coaches dagelijks mee te maken hebben.",
      "Als creatief oprichter is Jonas verantwoordelijk voor design, gebruikerservaring en marketing. Hij zorgt ervoor dat Rapply niet alleen goed werkt, maar ook prettig en intuitief aanvoelt. Jonas staat in nauw contact met coaches en re-integratiecoaches om het product continu te verbeteren.",
    ],
    image: jonasImage,
    textContainerClassName: "lg:px-[80px]",
