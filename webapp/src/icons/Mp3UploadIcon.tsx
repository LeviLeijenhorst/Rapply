...
export function Mp3UploadIcon({ size = 24 }: Props) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M2 12.98V15C2 20 4 22 9 22H11" stroke="#1D0A00" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
      <Path d="M22 10V9C22 4 20 2 15 2H9C4 2 2 4 2 9" stroke="#1D0A00" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
      <Path
      ...
      <Path
        ...
        strokeLinejoin="round"
      />
      <Path d="M16.71 16.43L22 14.99" stroke="#1D0A00" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  )
}
