...
export function ActionMenu({ visible, anchorPoint, placement, width, estimatedHeight, items, onClose }: Props) {
    ...
    <WebPortal>
      <View style={styles.overlay}>
        ...
        <Animated.View
          ...
          style={[styles.menu, { width, left, top, opacity, transform: [{ translateY }] }]}
        >
