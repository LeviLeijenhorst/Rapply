...
import { focusAndSelectAll } from '../inputs/TextInput'
...
export function SessieRenameModal({ visible, initialName, onClose, onSave }: Props) {
      ...
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <View style={styles.headerIconCircle}>
            <EditActionIcon color={colors.selected} size={18} />
          </View>
          {/* Header title */}
