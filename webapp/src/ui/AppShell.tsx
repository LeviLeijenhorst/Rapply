...
} from '../hooks/appShell/appShellBackend'
...
import { consumeSubscriptionReturnResumeRequest } from '../screens/record/subscriptionReturnDraftStore'
...
export function AppShell({ onLogout }: Props) {
  ...
  const mainContentKey = useMemo(
    ...
    [isAdminContactScreenOpen, isAdminScreenOpen, isAdminWachtlijstScreenOpen, isGeschrevenVerslagOpen, isNieuweRapportageOpen, rapportageScreenMode, isRecordPageOpen, isNewClientPageOpen, overlayScreenKey, selectedCoacheeId, selectedSessieId, selectedSidebarItemKey, selectedTrajectoryId],
  )
  ...
  const currentRoute = useMemo<RouteState>(
    ...
    [isAdminContactScreenOpen, isAdminScreenOpen, isAdminWachtlijstScreenOpen, isGeschrevenVerslagOpen, isNieuweRapportageOpen, isRecordPageOpen, isNewClientPageOpen, overlayScreenKey, selectedCoacheeId, selectedSessieId, selectedSidebarItemKey, selectedTrajectoryId],
  )
  const breadcrumbItems = useMemo(
    ...
    [data.coachees, data.sessions, data.trajectories, isNieuweRapportageOpen, isRecordPageOpen, isNewClientPageOpen, navigateTo, rapportageScreenMode, selectedCoacheeId, selectedSessieId, selectedSidebarItemKey, selectedTrajectoryId, writtenReportInitialCoacheeId],
  )
