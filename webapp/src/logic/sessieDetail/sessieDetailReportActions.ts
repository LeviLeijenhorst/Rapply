import { buildStructuredReportMarkdown } from '../../utils/reportGeneration'
...
import type { Activity, Coachee, Session, StructuredSessionSummary, Template, Trajectory } from '../../local/types'
