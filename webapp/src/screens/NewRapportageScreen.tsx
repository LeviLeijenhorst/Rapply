...
} from '../logic/reports/newRapportage/newRapportageWorkflows'
import { useLocalAppData } from '../local/LocalAppDataProvider'
import type { Template } from '../local/types'
...
import { parseReportSections } from '../utils/reportStructure'
import { isSessionNotesArtifact, isSessionPrimaryInputArtifact, isSessionReportArtifact } from '../utils/sessionArtifacts'
...
export function NewRapportageScreen({ initialCoacheeId = null, initialSessionId = null, mode = 'controleren' }: Props) {
