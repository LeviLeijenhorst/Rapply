...
import { runPrimaryFooterAction } from '../../hooks/newSession/newSessionModalActions'
...
export function NewSessionModal({
  ...
  return (
    <View style={[styles.overlay, limitedMode ? styles.overlayLimited : undefined]} pointerEvents="auto">
          ...
          !limitedMode
            ? {
                width: recordingExpandProgress.interpolate({
                  inputRange: [0, 1],
                  outputRange: [Math.min(BASE_RECORDING_MODAL_WIDTH, windowWidth * 0.95), Math.min(expandedRecordingWidth, windowWidth * 0.95)],
      ...
      >
        {/* Modal header */}
        {!limitedMode && !isDesktopRecordingStep ? <View style={styles.header}>
