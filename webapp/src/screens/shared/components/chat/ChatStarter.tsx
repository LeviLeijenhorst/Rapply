...
export function ChatStarter({ templates, onSelectOption }: Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Modal visible={isOptionsModalVisible} onClose={() => setIsOptionsModalVisible(false)} contentContainerStyle={styles.modalContainer}>
...
export const QuickQuestionsStart = ChatStarter
