...
let RapplyFallbackLogoDataUrlCache: string | null | undefined
const RapplyFallbackLogoPngDataUrl =
...
async function getRapplyFallbackLogoDataUrl() {
  if (RapplyFallbackLogoDataUrlCache !== undefined) return RapplyFallbackLogoDataUrlCache
  RapplyFallbackLogoDataUrlCache = RapplyFallbackLogoPngDataUrl
  return RapplyFallbackLogoDataUrlCache
}
...
export async function exportMessageToPdf(messageText: string, reportTitle: string | undefined, organizationSettings: PdfPracticeSettings) {
  ...
  const title = String(reportTitle || '').trim() || fallbackTitle || 'Rapply export'
  const fallbackLogoDataUrl = await getRapplyFallbackLogoDataUrl()
