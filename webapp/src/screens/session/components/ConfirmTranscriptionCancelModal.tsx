...
export function ConfirmTranscriptionCancelModal({ visible, onClose, onConfirm }: Props) {
    ...
    <AnimatedOverlayModal visible={visible} onClose={onClose} contentContainerStyle={styles.container}>
      ...
      <View style={styles.body}>
        ...
        <Text style={styles.descriptionText}>
          Als je nu annuleert, wordt de audio verwijderd en wordt dit gesprek verwijderd. Weet je zeker dat je wilt doorgaan?
        </Text>
      </View>
