...
import { ConfirmNoteDeleteModal } from '../components/notes/ConfirmNoteDeleteModal'
import { Text } from '../ui/Text'
import { saveCoacheeProfileChanges, saveNewCoacheeNote } from '../logic/coacheeDetail/coacheeDetailActions'
import {
...
} from '../logic/coacheeDetail/coacheeDetailData'
import { useCoacheeDetailChatFlow } from '../hooks/coacheeDetail/useCoacheeDetailChatFlow'
import { ExpandableSearchField } from '../foundation/ui/inputs/ExpandableSearchField'
...
export function CoacheeDetailScreen({
  coacheeId,
  onBack,
  onSelectSession,
  ...
  const coacheeName = coachee?.name ?? 'CliÃ«nt'
