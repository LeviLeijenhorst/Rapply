...
export default function Coachees({ color = colors.textPrimary, size = 24 }: { color?: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M12.6796 3.96C13.1596 4.67 13.4396 5.52 13.4396 6.44C13.4296 8.84 11.5396 10.79 9.15957 10.87C9.05957 10.86 8.93957 10.86 8.82957 10.87C6.44957 10.79 4.55957 8.84 4.55957 6.44C4.55957 3.99 6.53957 2 8.99957 2"
        stroke={color}
        strokeWidth={1.5}
        strokeLinecap="round"
